...
namespace sjc.App.Private
{
    public partial class UserPrincipal : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!(MisSolicitudes.Rows.Count == 0))
            {
                MisSolicitudes.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
        ...
        {
            if (new cSolicitudes().getUserSoli(new _Session().getIdCiudadano()).Tables[0].Rows.Count == 0)
            {MisSolicitudesMessages.Text = "<div class=\"text-center\">No ha realizado ninguna solicitud</div>";return;}

            MisSolicitudes.DataSource = new cSolicitudes().getUserSoli(new _Session().getIdCiudadano());
            MisSolicitudes.DataBind();
            MisSolicitudes.HeaderRow.TableSection = TableRowSection.TableHeader;  
        }

        protected void cancelar_boton_Click(object sender, EventArgs e)
        {
            ...
            EliminarTramiteId.Text = selectedrow.Cells[0].Text;
            EliminarTramiteEstado.Text = selectedrow.Cells[1].Text;
            EliminarTramiteCategoria.Text = selectedrow.Cells[2].Text;
            EliminarTramiteFecha.Text = selectedrow.Cells[3].Text;

            Page.ClientScript.RegisterStartupScript(GetType(), "showmodal", "mostrarModal(\"cancelarTramiteModal\")", true);
